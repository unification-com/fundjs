...
const createLCDClient = async ({ restEndpoint }) => {
    ...
    return {
        mainchain: {
            beacon: {
                v1: new (await Promise.resolve().then(() => __importStar(require("./beacon/v1/query.lcd")))).LCDQueryClient({
                    requestClient
                })
            },
            enterprise: {
                v1: new (await Promise.resolve().then(() => __importStar(require("./enterprise/v1/query.lcd")))).LCDQueryClient({
                    requestClient
                })
            },
            stream: {
                v1: new (await Promise.resolve().then(() => __importStar(require("./stream/v1/query.lcd")))).LCDQueryClient({
                    requestClient
                })
            },
            wrkchain: {
                v1: new (await Promise.resolve().then(() => __importStar(require("./wrkchain/v1/query.lcd")))).LCDQueryClient({
                    requestClient
                })
            }
        },
