        ...
        namespace transfer {
            const v1: {
                ...
                createRpcQueryHooks: (rpc: import("@cosmjs/stargate").ProtobufRpcClient | undefined) => {
                    useDenomTrace: <TData = _93.QueryDenomTraceResponse>({ request, options }: _221.UseDenomTraceQuery<TData>) => any;
                    useDenomTraces: <TData = _93.QueryDenomTracesResponse>({ request, options }: _221.UseDenomTracesQuery<TData>) => any;
                    useParams: <TData = _93.QueryParamsResponse>({ request, options }: _221.UseParamsQuery<TData>) => any;
                };
    ...
    namespace core {
        namespace channel {
            const v1: {
                ...
                createRpcQueryHooks: (rpc: import("@cosmjs/stargate").ProtobufRpcClient | undefined) => {
                    useChannel: <TData = _99.QueryChannelResponse>({ request, options }: _222.UseChannelQuery<TData>) => any;
                    useChannels: <TData = _99.QueryChannelsResponse>({ request, options }: _222.UseChannelsQuery<TData>) => any;
                    useConnectionChannels: <TData = _99.QueryConnectionChannelsResponse>({ request, options }: _222.UseConnectionChannelsQuery<TData>) => any;
                    useChannelClientState: <TData = _99.QueryChannelClientStateResponse>({ request, options }: _222.UseChannelClientStateQuery<TData>) => any;
                    useChannelConsensusState: <TData = _99.QueryChannelConsensusStateResponse>({ request, options }: _222.UseChannelConsensusStateQuery<TData>) => any;
                    usePacketCommitment: <TData = _99.QueryPacketCommitmentResponse>({ request, options }: _222.UsePacketCommitmentQuery<TData>) => any;
                    usePacketCommitments: <TData = _99.QueryPacketCommitmentsResponse>({ request, options }: _222.UsePacketCommitmentsQuery<TData>) => any;
                    usePacketReceipt: <TData = _99.QueryPacketReceiptResponse>({ request, options }: _222.UsePacketReceiptQuery<TData>) => any;
                    usePacketAcknowledgement: <TData = _99.QueryPacketAcknowledgementResponse>({ request, options }: _222.UsePacketAcknowledgementQuery<TData>) => any;
                    usePacketAcknowledgements: <TData = _99.QueryPacketAcknowledgementsResponse>({ request, options }: _222.UsePacketAcknowledgementsQuery<TData>) => any;
                    useUnreceivedPackets: <TData = _99.QueryUnreceivedPacketsResponse>({ request, options }: _222.UseUnreceivedPacketsQuery<TData>) => any;
                    useUnreceivedAcks: <TData = _99.QueryUnreceivedAcksResponse>({ request, options }: _222.UseUnreceivedAcksQuery<TData>) => any;
                    useNextSequenceReceive: <TData = _99.QueryNextSequenceReceiveResponse>({ request, options }: _222.UseNextSequenceReceiveQuery<TData>) => any;
                };
        ...
        namespace client {
            const v1: {
                ...
                createRpcQueryHooks: (rpc: import("@cosmjs/stargate").ProtobufRpcClient | undefined) => {
                    useClientState: <TData = _103.QueryClientStateResponse>({ request, options }: _223.UseClientStateQuery<TData>) => any;
                    useClientStates: <TData = _103.QueryClientStatesResponse>({ request, options }: _223.UseClientStatesQuery<TData>) => any;
                    useConsensusState: <TData = _103.QueryConsensusStateResponse>({ request, options }: _223.UseConsensusStateQuery<TData>) => any;
                    useConsensusStates: <TData = _103.QueryConsensusStatesResponse>({ request, options }: _223.UseConsensusStatesQuery<TData>) => any;
                    useClientStatus: <TData = _103.QueryClientStatusResponse>({ request, options }: _223.UseClientStatusQuery<TData>) => any;
                    useClientParams: <TData = _103.QueryClientParamsResponse>({ request, options }: _223.UseClientParamsQuery<TData>) => any;
                    useUpgradedClientState: <TData = _103.QueryUpgradedClientStateResponse>({ request, options }: _223.UseUpgradedClientStateQuery<TData>) => any;
                    useUpgradedConsensusState: <TData = _103.QueryUpgradedConsensusStateResponse>({ request, options }: _223.UseUpgradedConsensusStateQuery<TData>) => any;
                };
        ...
        namespace connection {
            const v1: {
                ...
                createRpcQueryHooks: (rpc: import("@cosmjs/stargate").ProtobufRpcClient | undefined) => {
                    useConnection: <TData = _108.QueryConnectionResponse>({ request, options }: _224.UseConnectionQuery<TData>) => any;
                    useConnections: <TData = _108.QueryConnectionsResponse>({ request, options }: _224.UseConnectionsQuery<TData>) => any;
                    useClientConnections: <TData = _108.QueryClientConnectionsResponse>({ request, options }: _224.UseClientConnectionsQuery<TData>) => any;
                    useConnectionClientState: <TData = _108.QueryConnectionClientStateResponse>({ request, options }: _224.UseConnectionClientStateQuery<TData>) => any;
                    useConnectionConsensusState: <TData = _108.QueryConnectionConsensusStateResponse>({ request, options }: _224.UseConnectionConsensusStateQuery<TData>) => any;
                };
