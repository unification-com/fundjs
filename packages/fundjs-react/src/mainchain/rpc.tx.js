...
const createRPCMsgClient = async ({ rpc }) => ({
    mainchain: {
        beacon: {
            v1: new (await Promise.resolve().then(() => __importStar(require("./beacon/v1/tx.rpc.msg")))).MsgClientImpl(rpc)
        },
        enterprise: {
            v1: new (await Promise.resolve().then(() => __importStar(require("./enterprise/v1/tx.rpc.msg")))).MsgClientImpl(rpc)
        },
        stream: {
            v1: new (await Promise.resolve().then(() => __importStar(require("./stream/v1/tx.rpc.msg")))).MsgClientImpl(rpc)
        },
        wrkchain: {
            v1: new (await Promise.resolve().then(() => __importStar(require("./wrkchain/v1/tx.rpc.msg")))).MsgClientImpl(rpc)
        }
    },
    cosmos: {
        authz: {
