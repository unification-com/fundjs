...
export declare const createRpcQueryHooks: (rpc: ProtobufRpcClient | undefined) => {
    ...
    /** Allowances returns all the grants for address. */ useAllowances: <TData = QueryAllowancesResponse>({ request, options }: UseAllowancesQuery<TData>) => any;
    /**
     * AllowancesByGranter returns all the grants given by an address
     * Since v0.46
     */
    useAllowancesByGranter: <TData = QueryAllowancesByGranterResponse>({ request, options }: UseAllowancesByGranterQuery<TData>) => any;
};
