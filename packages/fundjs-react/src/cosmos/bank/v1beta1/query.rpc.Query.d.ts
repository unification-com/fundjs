...
export declare const createRpcQueryHooks: (rpc: ProtobufRpcClient | undefined) => {
    ...
    /** AllBalances queries the balance of all coins for a single account. */ useAllBalances: <TData = QueryAllBalancesResponse>({ request, options }: UseAllBalancesQuery<TData>) => any;
    /**
     * SpendableBalances queries the spenable balance of all coins for a single
     * account.
     */
    useSpendableBalances: <TData = QuerySpendableBalancesResponse>({ request, options }: UseSpendableBalancesQuery<TData>) => any;
    /** TotalSupply queries the total supply of all coins. */ useTotalSupply: <TData = QueryTotalSupplyResponse>({ request, options }: UseTotalSupplyQuery<TData>) => any;
    /** SupplyOf queries the supply of a single coin. */ useSupplyOf: <TData = QuerySupplyOfResponse>({ request, options }: UseSupplyOfQuery<TData>) => any;
    /** Params queries the parameters of x/bank module. */ useParams: <TData = QueryParamsResponse>({ request, options }: UseParamsQuery<TData>) => any;
    /** DenomsMetadata queries the client metadata of a given coin denomination. */ useDenomMetadata: <TData = QueryDenomMetadataResponse>({ request, options }: UseDenomMetadataQuery<TData>) => any;
    /**
     * DenomsMetadata queries the client metadata for all registered coin
     * denominations.
     */
    useDenomsMetadata: <TData = QueryDenomsMetadataResponse>({ request, options }: UseDenomsMetadataQuery<TData>) => any;
    /**
     * DenomOwners queries for all account addresses that own a particular token
     * denomination.
     */
    useDenomOwners: <TData = QueryDenomOwnersResponse>({ request, options }: UseDenomOwnersQuery<TData>) => any;
};
