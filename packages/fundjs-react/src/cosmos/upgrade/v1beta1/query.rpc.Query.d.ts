...
export declare const createRpcQueryHooks: (rpc: ProtobufRpcClient | undefined) => {
    ...
    /** AppliedPlan queries a previously applied upgrade plan by its name. */ useAppliedPlan: <TData = QueryAppliedPlanResponse>({ request, options }: UseAppliedPlanQuery<TData>) => any;
    /**
     * UpgradedConsensusState queries the consensus state that will serve
     * as a trusted kernel for the next version of this chain. It will only be
     * stored at the last height of this chain.
     ...
     * (https://github.com/cosmos/ibc-go/blob/2c880a22e9f9cc75f62b527ca94aa75ce1106001/proto/ibc/core/client/v1/query.proto#L54)
     */
    useUpgradedConsensusState: <TData = QueryUpgradedConsensusStateResponse>({ request, options }: UseUpgradedConsensusStateQuery<TData>) => any;
    /**
     * ModuleVersions queries the list of module versions from state.
     *
     * Since: cosmos-sdk 0.43
     */
    useModuleVersions: <TData = QueryModuleVersionsResponse>({ request, options }: UseModuleVersionsQuery<TData>) => any;
    /** Returns the account with authority to conduct upgrades */ useAuthority: <TData = QueryAuthorityResponse>({ request, options }: UseAuthorityQuery<TData>) => any;
};
