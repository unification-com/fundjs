...
export declare const createRpcQueryHooks: (rpc: ProtobufRpcClient | undefined) => {
     ...
     * Since: cosmos-sdk 0.46
     */
    useGranterGrants: <TData = QueryGranterGrantsResponse>({ request, options }: UseGranterGrantsQuery<TData>) => any;
    /**
     * GranteeGrants returns a list of `GrantAuthorization` by grantee.
     *
     * Since: cosmos-sdk 0.46
     */
    useGranteeGrants: <TData = QueryGranteeGrantsResponse>({ request, options }: UseGranteeGrantsQuery<TData>) => any;
};
