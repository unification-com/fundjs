...
export declare const createRpcQueryHooks: (rpc: ProtobufRpcClient | undefined) => {
    ...
    /** GetTx fetches a tx by hash. */ useGetTx: <TData = GetTxResponse>({ request, options }: UseGetTxQuery<TData>) => any;
    /** BroadcastTx broadcast transaction. */ useBroadcastTx: <TData = BroadcastTxResponse>({ request, options }: UseBroadcastTxQuery<TData>) => any;
    /** GetTxsEvent fetches txs by event. */ useGetTxsEvent: <TData = GetTxsEventResponse>({ request, options }: UseGetTxsEventQuery<TData>) => any;
    /**
     * GetBlockWithTxs fetches a block with decoded txs.
     *
     * Since: cosmos-sdk 0.45.2
     */
    useGetBlockWithTxs: <TData = GetBlockWithTxsResponse>({ request, options }: UseGetBlockWithTxsQuery<TData>) => any;
};
